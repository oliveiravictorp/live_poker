defmodule LivePokerWeb.CoreComponents do
  @moduledoc """
  ...
  def flash(assigns) do
    ...
    <div
      ...
      role="alert"
      class={[
        "fixed mt-2 right-2 mr-2 w-80 sm:w-96 z-50 rounded-lg p-3 ring-1",
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(LivePokerWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(LivePokerWeb.Gettext, "errors", msg, opts)
    end
  end
